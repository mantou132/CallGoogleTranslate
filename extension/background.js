...
/* harmony import */ var webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! webextension-polyfill-ts */ "./node_modules/webextension-polyfill-ts/dist/generated/index.js");
...
const port = webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].runtime.connectNative('google_translate_bridge');
function process({ frameId }) {
    const code = `(() => {
    ...
    webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].tabs.executeScript({ code, frameId }).then((result = []) => {
        result[0] &&
            port.postMessage({
                type: 'translate-text',
                data: result[0],
...
function createMenu() {
    webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].contextMenus.create({
        id: 'googletranslate',
...
function removeMenu() {
    webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].contextMenus.remove('googletranslate');
}
